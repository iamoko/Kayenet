...
"				<h2 class=\"dummy-heading\">Kayenet Admin DashBoard</h2>\n" +
"			</div>\n" +
"			<div class=\"bp-header__main\">\n" +
"				<span class=\"bp-header__present\">Amoko Ivan <span class=\"bp-tooltip bp-icon bp-icon--about\" data-content=\"The Kayenet Web Application Design and Developed by Amoko Ivan\"></span></span>\n" +
"				\n" +
"			</div>\n" +
"		</header>\n" +
"\n" +
...
"				<td class=\"cell100 column3\">"+rs.getString(2) +"</td>\n" +
                                "<td class=\"cell100 column4\">"+rs.getString(3)+"</td>"+
"			</tr>");
        ...
        for(int y = 0 ; y < j ; y ++) {
         ...
         for(int l = 0 ; l < j ; l ++ ){
           ...
           out.println("<tr class=\"row100 body\"><td class=\"cell100 column1\">Date: " + dates[l]+"</td><td class=\"cell100 column1\">Total: "+values_got[l]+"</td></tr>");
...
"				<td class=\"cell100 column3\">"+rs.getString(1) +"</td>\n" +
                                "<td class=\"cell100 column4\">"+rs.getString(2)+"</td>"+
                                 "<td class=\"cell100 column5\">"+rs.getString(3)+"</td>"+
"			</tr>");
                       }
                }
            }
        ...
        for(int u = 0; u< times;u++){
            //out.println("Total for Week: " + (u+1)+" "+weekTotal[u]);  
             out.println("<tr class=\"row100 body\"><td class=\"cell100 column1\">Week: " + (u+1)+"</td><td class=\"cell100 column1\">Total: "+weekTotal[u]+"</td></tr>");
        }
...
"			</tr>");
        ...
        for(int u = 0; u< timers;u++){
            ...
            out.println("<tr class=\"row100 body\"><td class=\"cell100 column1\">Month: " + (u+1)+"</td><td class=\"cell100 column1\">Total: "+monthTotal[u]+"</td></tr>");
